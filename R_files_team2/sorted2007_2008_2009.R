...
read.csv("F:/UTA/Courses/Assignments/Data Mining/Project2/feb2007_feb2008.csv") %>%
  full_join(read.csv("F:/UTA/Courses/Assignments/Data Mining/Project2/feb2009.csv")) %>%
...
write.csv(df_2007,"F:/UTA/Courses/Assignments/Data Mining/Project2/feb2007_feb2008_feb2009.csv", row.names = TRUE)