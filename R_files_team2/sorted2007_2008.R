...
read.csv("F:/UTA/Courses/Assignments/Data Mining/Project2/feb2007.csv") %>%
  full_join(read.csv("F:/UTA/Courses/Assignments/Data Mining/Project2/feb2008.csv")) %>%
...
write.csv(df_2007,"F:/UTA/Courses/Assignments/Data Mining/Project2/feb2007_feb2008.csv", row.names = TRUE)