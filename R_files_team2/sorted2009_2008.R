...
read.csv("F:/UTA/Courses/Assignments/Data Mining/Project2/feb2009.csv") %>%
...
write.csv(df_2007,"F:/UTA/Courses/Assignments/Data Mining/Project2/feb2009_feb2008.csv", row.names = TRUE)